...
{	
	...
	public Node_t() throws  IOException, NoSuchAlgorithmException 
	{
		...
		this.my_socket = new ServerSocket(9091/*SystemParam.GotGlobalPort2()*/);//SystemParam.GotGlobalPort());
	...
	public void process_case6(Req_t req) throws NoSuchAlgorithmException, ClassNotFoundException, IOException
	{
		...
		if(BasicCrypto.SignatureVerify1(msg, Test3.node.node_info.pk, req.Sig_from))
		{
			if(req.trans_type == 1)
			{
...
//				}
	...
	public void block_select() throws ClassNotFoundException, IOException, NoSuchAlgorithmException
	{
		...
		else
		{
			...
			temp = temp - time0;
			if((temp > 60000)&&(Test3.node.undecided_block_list.size() != 0))
			{
				this.time0 = 0;
				Block_t block = new Block_t();
